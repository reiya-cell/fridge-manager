const CACHE_NAME='fridge-manager-v47';
const APP_FILES=['./','./index.html','./styles.css','./app.js','./js/app-utils.js','./js/camera-service.js','./cloud-config.js','./manifest.webmanifest','./icons/app-icon.svg'];
