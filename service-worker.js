const CACHE_NAME='fridge-manager-v45';
const APP_FILES=['./','./index.html','./styles.css','./app.js','./js/app-utils.js','./cloud-config.js','./manifest.webmanifest','./icons/app-icon.svg'];
