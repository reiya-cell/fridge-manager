...
check(html.includes('styles.css?v=23')&&html.includes('app.js?v=23'),'CSS/JSのキャッシュ更新番号がありません');
...
check(html.includes('app.js?v=23'),'JavaScriptのキャッシュ更新番号がありません');
...
check(html.includes('styles.css?v=23'),'CSSのキャッシュ更新番号がありません');
