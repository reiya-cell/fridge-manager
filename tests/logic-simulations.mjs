...
check(html.includes('styles.css?v=45')&&html.includes('app.js?v=45'),'CSS/JSのキャッシュ更新番号がありません');
...
check(html.includes('app.js?v=45'),'JavaScriptのキャッシュ更新番号がありません');
...
check(html.includes('styles.css?v=45'),'CSSのキャッシュ更新番号がありません');
...
check(html.indexOf("document.getElementById('itemCount')")<html.indexOf('app.js?v=45'),'件数先行表示がapp.jsより後です');
...
check(html.includes('cloud-config.js?v=45')&&source.includes('@supabase/supabase-js@2'),'Supabaseクライアント設定がありません');
...
check(html.includes('js/app-utils.js?v=45')&&html.includes('app.js?v=45')&&serviceWorker.includes("fridge-manager-v45"),'公開キャッシュ番号が一致しません');
...
check(html.indexOf('js/app-utils.js?v=45')<html.indexOf('app.js?v=45'),'共通処理がapp.jsより後に読み込まれています');
