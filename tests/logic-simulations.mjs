...
check(html.includes('styles.css?v=28')&&html.includes('app.js?v=27'),'CSS/JSのキャッシュ更新番号がありません');
...
check(html.includes('app.js?v=27'),'JavaScriptのキャッシュ更新番号がありません');
...
check(html.includes('styles.css?v=28'),'CSSのキャッシュ更新番号がありません');
...
check(html.indexOf("document.getElementById('itemCount')")<html.indexOf('app.js?v=27'),'件数先行表示がapp.jsより後です');
